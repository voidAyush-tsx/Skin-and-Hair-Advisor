...
import { Upload, Camera, Image, FileText, Loader2, CheckCircle } from 'lucide-react';
      ...
      setAnalysisProgress(prev => {
        if (prev >= 100) {
          ...
          setAnalysisResults({
            ...
            recommendations: [
              { type: 'Shampoo', description: 'Sulfate-free moisturizing shampoo' },
              { type: 'Conditioner', description: 'Deep conditioning treatment with protein' },
              { type: 'Treatment', description: 'Leave-in conditioner with heat protection' },
              { type: 'Styling', description: 'Curl-defining cream with medium hold' }
            ]
          });
